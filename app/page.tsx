  ...
  return (
    <div className="h-screen w-full bg-cover bg-center bg-[url(/img/whiteAbstractBg.jpg)] filter brightness-108">
      ...
      <div className="flex flex-col items-center justify-center h-full">
        <img  src="/img/dempaLogo.png" alt="Dempa Logo" className="drop-shadow-lg shadow-black/90 h-[40vh] md:h-[516px] md:w-[516px]"></img>
        <img src="/img/dempaLogoTxt.png" alt="Logo Text" className="h-[10vh] drop-shadow-lg shadow-black/90 md:h-[184px] md:w-[516px]"></img>
