  ...
  return (
    <div className="z-50">
      <div className="fixed left-0 top-0 h-[11vh] w-full bg-white text-black shadow-[0px_2px_10px_-3px_#000000] z-60 flex items-center px-4 overflow-hidden ">
          ...
          <div className={`transition-all duration-100 ease-in-out overflow-hidden flex absolute items-center gap-[1vw] ${isOpen? "left-[16vw]" : "left-[6vw]"}`}>
          ...
          >
              <Link href="/dashboardPage">
                <div className={`items-center h-[10vh] w-full hover:bg-[#2a58ad] ${isOpen? "grid grid-cols-2 px-[2vw] ": "flex justify-center"}`}>
                  ...
                  <div className={`transition-all duration-100 ease-in-out ${isOpen? "block": "hidden"}`}>
              ...
              <div
                className={`items-center h-[10vh] w-full hover:bg-[#2a58ad] ${isOpen? "grid grid-cols-2 px-[2vw] ": "flex justify-center"}`}
                onClick={() => {
                  openClicked();
                }}
              >
