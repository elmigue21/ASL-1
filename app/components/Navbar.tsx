    ...
    <div className="z-50">
      <div className="fixed left-0 top-0 h-25 w-full bg-white text-black py-4 shadow-[0px_2px_10px_-3px_#000000] z-50 flex items-center px-4">
        ...
        <div className="flex items-center gap-x-3  mx-auto fixed left-50">
          <Image src="dempaLogo.png" alt="Logo" className="h-20 w-20" />
          <Image src="dempaLogoTxt.png" alt="Logo Text" className="w-42 h-9" />
      ...
      >
        ...
        <div className="flex flex-row justify-center gap-x-3">
          {" "}
          <Image src="refresh.png" alt="User Update" className="w-8 h-8" />
          <h2 className="items-center mt-1">User Update</h2>
          </div>
        <div className="flex flex-row justify-center gap-x-3">
          {" "}
          <Image src="user-add.png" alt="Add Account" className="w-8 h-8" />
