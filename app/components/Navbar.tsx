  ...
  return (
    <div className='z-50'>
      <div className="fixed left-0 top-0 h-25 w-full bg-white text-black py-4 shadow-[0px_2px_10px_-3px_#000000] z-50 flex items-center px-4">
        ...
        <ul><img src="menu-burger.png" alt="Hamburger Menu" className="w-10 h-8"/></ul>
        </div>
      ...
      <div className="flex items-center gap-x-3  mx-auto fixed left-50">
       ...
       <div style={{ fontFamily: 'Inter, sans-serif' }} className="fixed left-0 top-25 h-full w-40 bg-[#1e2e80] text-white flex flex-col py-12  z-40 text-m gap-y-12">
          ...
          <div className='flex flex-row justify-center gap-x-3 text-xl'> <img src="circle-user.png" alt="Account" className="w-10 h-10"/><h2 className='items-center mt-1'>Account</h2></div>
          <div className='flex flex-row justify-center gap-x-3 text-xl me-5'> <img src="mail-plus-circle.png" alt="Inbox" className="w-10 h-10"/><h2 className='items-center mt-1'>Inbox</h2></div>
          <div className='mt-auto flex flex-row justify-center gap-x-3 text-lg me-5 pb-16'> <img src="exit.png" alt="Inbox" className="w-9 h-9"/><h2 className='items-center mt-1'>Log Out</h2></div>
        </div>
    </div>
