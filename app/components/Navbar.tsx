    ...
    <div className='z-50'>
      ...
      <div className="flex items-center gap-x-3  mx-auto fixed left-50">
       ...
       <div style={{ fontFamily: 'Inter, sans-serif' }} className="fixed left-0 top-25 h-full w-40 bg-[#1e2e80] text-white flex flex-col py-12  z-40 text-m gap-y-12 font-bold">
          ...
          <Link href={"/"}><div className='mt-[10vh] flex flex-row justify-center gap-x-3 text-lg'> <img src="exit.png" alt="Inbox" className="w-9 h-9"/><h2 className='items-center mt-1'>Log Out</h2></div></Link>
        </div>
    </div>
