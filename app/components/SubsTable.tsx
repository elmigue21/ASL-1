...
import DoubleLeftAngle from "@/public/angle-double-small-left.svg"
import DoubleRightAngle from "@/public/angle-double-small-right.svg"
import LeftAngle from "@/public/angle-small-left.svg"
import RightAngle from "@/public/angle-small-right.svg"
...
const SubTable = () => {
  ...
  const isTallViewport = useMediaQuery("(min-height: 800px)");
    ...
    const initialPageSize = isMobile ? 5 : isTallViewport ? 10 : 8;
    ...
    const isEmailOpen = useSelector((state: RootState) => state.EmailWindowSlice.isOpen);  
    ...
    return isMobile ? (
      ...
      isEmailOpen?(
        <SubscriptionsTableDesktopEmail
        subscriptions={subscriptions}
        isLoading={isLoading}
        pagination={pagination}
        goToPage={goToPage}
...
function SubscriptionsTableDesktopEmail({
  subscriptions,
  isLoading,
  pagination,
  goToPage,
    ...
    <div className="w-[40vw] z-50">
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        ...
        <div className="flex flex-row space-x-2 sticky">
          <Button
            className="cursor-pointer hover:bg-slate-200 active:scale-80 transition-transform duration-300"
            variant="outline"
            size="sm"
            onClick={() => {
              setPagination((prev) => ({
          ...
          >
            <DoubleLeftAngle className="hover:text-black"/>
